    ...
    <View className='bg-slate-900 flex-1'>
      <ScrollView contentContainerStyle={{
        ...
        <View className='flex-col items-start justify-center mt-5 px-5'>
          ...
          <View className='flex-row items-center bg-slate-800 px-2 py-1 rounded-md gap-x-1 mt-2'>
          ...
          <MovieInfo label='Production Compines' value={movie?.production_companies.map((c) => c.name).join('-') || 'N/A'} />
        </View>
      </ScrollView>
      <TouchableOpacity
